...
```
### Ejercicio 8. Capturar n numeros en el rango [LI,LS] donde:
...
cual de los dos promedios es mayor. (for)
#### 1.1 Analisis. 
#### 1.2 DFD
...
la cantidad de numeros pares y su promedio. 
la cantidad de numeros impares y su promedio. 
cual de los dos promedios es mayor. (while)
#### 1.1 Analisis. 
#### 1.2 DFD
...
la cantidad de numeros pares y su promedio. 
la cantidad de numeros impares y su promedio. 
cual de los dos promedios es mayor. (dowhile)
#### 1.1 Analisis. 
#### 1.2 DFD
...
### Ejercicio 10. Capture 10 numeros positivos enteros e indique que número es mayor y que número es menor.
#### 1.1 Analisis.
Crearemos un vector donde ingresaremos números dados por el usuario colocando diferentes filtros donde clasifiquemos "mayor que" y "menor que", intraran a diversos ciclos donde se almacenarán y agregaran valores segun su orden, una ves que estos esten almacenados en sus vectores podremos identificar cual es el valor mas chico y cual es el valor mas grande.
#### 1.2 DFD.
